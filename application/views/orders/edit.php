        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo isset($order_data['order']['id']) ? base_url() . 'Controller_Orders/printDiv/'.$order_data['order']['id'] : '#' ?>" class="btn bg-blue" >Print</a>
...
<script type="text/javascript">
  ...
  function getTotal(row = null) {
    if(row) {
      var total = Number($("#rate_value_"+row).val()); // Quantity removed
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      // $("#qty_"+row_id).val(""); // Quantity removed
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          // $("#qty_"+row_id).val(1); // Quantity removed
          // $("#qty_value_"+row_id).val(1); // Quantity removed
