<aside class="main-sidebar ui-main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu ui-sidebar-menu" data-widget="tree">
            ...
            <?php if(array_intersect(['createStore','updateStore','viewStore','deleteStore'], $user_permission)): ?>
            <li id="storeNav">
            ...
            <?php if(array_intersect(['createProduct','updateProduct','viewProduct','deleteProduct'], $user_permission)): ?>
            ...
            <?php if(array_intersect(['createOrder','updateOrder','viewOrder','deleteOrder'], $user_permission)): ?>
            ...
            <?php if(array_intersect(['createGroup','updateGroup','viewGroup','deleteGroup'], $user_permission)): ?>
